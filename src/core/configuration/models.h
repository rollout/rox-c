 ...
 * @param archived
 * @param flags List of strings. Can be NULL. If passed, ownership of this object is delegated to the experiment. Instead, the shallow copy of the list is created.
 * @param labels Set of strings. Can be NULL. If passed, ownership of this object is delegated to the experiment. Instead, the shallow copy of the list is created.

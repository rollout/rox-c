...
extern const ROX_INTERNAL PropertyType ROX_PROPERTY_TYPE_FEATURE_FLAGS_STRING;
extern const ROX_INTERNAL PropertyType ROX_PROPERTY_TYPE_REMOTE_VARIABLES_STRING;
extern const ROX_INTERNAL PropertyType ROX_PROPERTY_TYPE_CUSTOM_PROPERTIES_STRING;
